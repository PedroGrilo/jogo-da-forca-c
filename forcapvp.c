  ...
  do {
    ...
    if (falhascount != 7 && falhascount != 6) {
      ...
      if (i < 2 && isvogal(tentativa[i])) {
        system("cls");
        strcpy(msg,
               "\nN�O sao aceites vogais at�� terceira ronda, tente novamente!\n");
        continue;
      }
      ...
      if (isdigit(tentativa[i])) {
        if (tentativa[i] != '0') {
          system("cls");
          strcpy(msg, "\nN�O s�o aceites numeros, tente novamente!\n");
          continue;
        } else {
          system("cls");
          strcpy(msg, "\n");
      ...
      if (tentativa[i] == ' ') {
        system("cls");
        strcpy(msg, "\nN�O s�o aceites espacos, tente novamente!\n");
        ...
        system("cls");
        strcpy(msg,
               "\nN�O s�o aceites caracteres especiais, tente novamente!\n");
                               ...
                               // espaços inciais e caracteres especiais
{
  ...
  if (strlen(nome) < 3) {
    ...
    printf("A frase N�O pode conter espa�os iniciais\n\n");
    return 1;
  } else {
    int tst = 0;
    ...
    if (tst == 1) {
      printf("A frase S� pode conter letras.\n\n");
      return 1;
    } else
      return 0;
  }
